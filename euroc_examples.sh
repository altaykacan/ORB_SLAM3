#!/bin/bash
pathDatasetEuroc='/home/altay/thesis/data/euroc/' #Example, it is necesary to change it by the dataset path

#------------------------------------
# Monocular Examples
echo "Launching MH03 with Monocular sensor"
./Examples/Monocular/mono_euroc ./Vocabulary/ORBvoc.txt ./Examples/Monocular/EuRoC.yaml "$pathDatasetEuroc" ./Examples/Monocular/EuRoC_TimeStamps/MH03.txt dataset-MH03_mono
